                ...
                >
                  ...
                  <td class="px-3 py-2">
                    <button
                      ...
                      class="p-1 text-text-muted hover:text-danger opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity disabled:cursor-not-allowed disabled:hover:text-text-muted disabled:group-hover:opacity-30 disabled:focus-visible:opacity-30"
